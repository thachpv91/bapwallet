...
public class CoinDefinition {
    ...
    public static final String coinName = "HanhCoin";
    public static final String coinTicker = "HHC";
    public static final String coinURIScheme = "hanhcoin";
    ...
    public static final int TARGET_SPACING_0 = (int)(1 * 30);  // 20 seconds per block.
...
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
    */
    ...
    public static final int TARGET_SPACING= (int)(1 * 30);  // 20 seconds per block.
...
/*
    ...
    */
    ...
    static public long genesisBlockDifficultyTarget = (0x1e0ffff0L);    //0x1e0ffff0     //main.cpp: LoadBlockIndex
    ...
    public static final String ID_MAINNET = "org.bapcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.bapcoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.bapcoin.unittest";
